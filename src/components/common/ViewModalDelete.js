...
export default function ViewModalDelete({ open, handleOpen, handleClose,closeSignModal,rowDataToDisplay, data,show ,title}) {
                            ...
                            <tbody style={{border:'1px solid lightgrey'}}>
                                {headers.map((header, i) => (
                                    <tr key={i} style={{border:'1px solid lightgrey'}}>
                                        ...
                                        {
                                            show==="1" ? <td style={{textAlign:'center'}}>{rowData[i]}</td> : <td style={{textAlign:'center'}}>{rowData[i+3]}</td>
