      ...
      >
        <div className={classes.Sbox}>
          <div className={classes.bluerow}>
            <div className={classes.bluerowtext}>UPI Transaction Browse</div>
            <div><ColorButton1 onClick={()=>navigate("/networkmaster/create")} variant="contained">
                Create
              </ColorButton1></div>
          </div>
          <div>
...
export default NetworkMasterBrowse;
