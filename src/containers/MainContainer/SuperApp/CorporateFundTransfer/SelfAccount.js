...
const SelfAccount = () => {
  ...
  return (
    ...
    <div className={classes.cardsmainpage}>
        ...
        <div className={classes.maintabbelowheading}> To Self Account</div>
       ...
       <TabPanel value="4"><SelfAccountPaymentDetails/></TabPanel>
         <TabPanel value="5"><SelfAccountPreview/></TabPanel>
         <TabPanel value="6"><SelfAccountSummary/></TabPanel>
