...
import classes from './BulkUploadViewModal.module.css';
...
export default function BulkUploadViewModal({ open, handleOpen, handleClose, rowDataToDisplay, data,show ,title}) {
