...
export default function DashboarCards({ card, getcount, messages }) {
  ...
  return (
    ...
    <>
      ...
      >
        ...
        <div className={classes.boxdesc}>{messages?.inservice ? messages?.inservice : getcount && getcount[0]?.inservice}</div>
      ...
      >
        ...
        <div className={classes.boxdesc}>{messages?.outofservice ? messages?.outofservice : getcount && getcount[0]?.outservice}</div>
      </div>
      ...
      >
        ...
        <div className={classes.boxdesc}>{messages?.atmoffline ? messages?.atmoffline : getcount && getcount[0]?.offline}</div>
      </div>
      ...
      >
        ...
        <div className={classes.boxdesc}>{messages?.supervisory ? messages?.supervisory : getcount && getcount[0]?.supervisoryin}</div>
      </div>
